        ...
        try:
            ...
            notification = {
                ...
                "data": {
                    "type": "daily_briefing",
                    "user_id": user_id,
                    "tasks_today": briefing_data["tasks_count"],
                    "upcoming_deadlines": briefing_data["deadlines_count"],
...
_notification_jobs: Optional[NotificationJobs] = None

def get_notification_jobs() -> NotificationJobs:
